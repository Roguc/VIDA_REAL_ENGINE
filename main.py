...
def main():
    ...
    print("=" * 70)
    print()
    print("[FECHA] Fecha:", sistema.fecha_texto)
    print("[HORA] Hora:", sistema.hora_actual)
    print("[EXCEL] Excel:", sistema.contexto["excel"]["archivo"])
    print("[HOJAS] Hojas:", sistema.contexto["excel"]["total_hojas"])
    print("[RECURSOS] Recursos:", sistema.recursos["total_archivos"], "archivos")
    print()
    log_buffer.append("")
    ...
    if motor.errores:
        print("[ERROR] ERRORES DETECTADOS:")
        ...
        print("[OK] Ejecución sin errores")
        log_buffer.append("✓ Ejecución sin errores")
        print()
        log_buffer.append("")

    print("[MOTORES] MOTORES ACTIVOS: 11")
    print("   [OK] MotorUniversidad (evaluaciones críticas)")
    print("   [OK] MotorSerpat (calendario laboral)")
    print("   [OK] MotorPendientes (tareas críticas)")
    print("   [OK] MotorVisionBoard (identidad 2042)")
    print("   [OK] MotorDesarrolloPersonal (Ley 001)")
    print("   [OK] MotorSalud (capital biológico)")
    print("   [OK] MotorFinanzas (capital financiero)")
    print("   [OK] MotorEmpresas (capital empresarial)")
    print("   [OK] MotorAncla (identidad diaria)")
    print("   [OK] MotorContinuidad (capitales)")
    print()
    ...
    try:
        ...
        print(f"[OK] Centro de Comando generado: {archivo_html}")
